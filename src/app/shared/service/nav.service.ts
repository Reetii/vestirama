...
export class NavService {
    ...
    MENUITEMS: Menu[] = [
        {
            title: 'New Arrivals', type: 'sub', children: [
        ...
        {
            title: 'Ceremony', type: 'sub', children: [
              /*  {
        ...
        {
            title: 'Ready To Wear', type: 'sub', children: [
        ...
        {
            title: 'Footwear', megaMenu: true, megaMenuType: 'small', type: 'sub', children: [
                /*{
        ...
        {
            title: 'Accessories', megaMenu: true, megaMenuType: 'medium', type: 'sub', children: [
                /*{
        ...
        {
            title: 'End Of Series', megaMenu: true, megaMenuType: 'large', type: 'sub', children: [
               /* {
        ...
        {
            title: 'Gift Card', megaMenu: true, megaMenuType: 'medium', type: 'sub', children: [
             /*   {
       ...
       /* {
            title: 'Factory Price', megaMenu: true, megaMenuType: 'medium', type: 'sub', children: [
                /!*   {
                       title: 'Header Style', type: 'link', children: [
                           {path: '/features/header-light', title: 'Light Header', type: 'link'},
                           {path: '/features/header-dark', title: 'Dark Header', type: 'link'},
        ...
        {
            title: 'Dresses', megaMenu: true, megaMenuType: 'medium', type: 'sub', children: [
                /!*   {
                       title: 'Header Style', type: 'link', children: [
                           {path: '/features/header-light', title: 'Light Header', type: 'link'},
                           {path: '/features/header-dark', title: 'Dark Header', type: 'link'},
